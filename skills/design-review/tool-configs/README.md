...
ln -sf /path/to/dune-skills/skills/design-review/tool-configs/cursor/design-review.mdc .cursor/rules/design-review.mdc
```
...
ln -sf /path/to/dune-skills/skills/design-review/tool-configs/claude-code/design-review.md .claude/commands/design-review.md
```
