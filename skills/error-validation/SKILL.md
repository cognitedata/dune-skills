...
See `../content-guidelines/SKILL.md` for full message patterns.
</message-patterns>
...
See `../content-guidelines/SKILL.md` for message wording.
</instruction>
...
action verb. See `../content-guidelines/SKILL.md` for copy.
</instruction>
