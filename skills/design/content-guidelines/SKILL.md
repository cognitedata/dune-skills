...
For code-level accessibility (keyboard nav, ARIA, focus), see `../accessibility/SKILL.md`.
...
For code-level accessibility (keyboard nav, ARIA, focus rings), see `../accessibility/SKILL.md`.
