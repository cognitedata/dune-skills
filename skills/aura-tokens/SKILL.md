...
See `../aura-components/SKILL.md` for the full list of 
...
Use the Aura Empty State component (`../aura-components/SKILL.md`).
See Storybook: https://cognitedata.github.io/aura/storybook/?path=/docs/primitives-empty-state--docs
See `../content-guidelines/SKILL.md` for copy patterns.
</instruction>
</rule>
...
`../layout-patterns/SKILL.md`. Do not invent new page layouts.
</instruction>
</rule>
