...
> **Related**: This guide covers content/writing accessibility.
> For code-level accessibility (keyboard navigation, ARIA attributes,
> focus management, alt text patterns), see **design-accessibility** skill.
